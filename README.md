...
###### Приложение - Консольный файл-менеджер с помощью команд позволяет бегать по каталогам, копировать, удалять и получать информацию файлов и папок. При первом запуске приложения открывается папка расположения приложения. В папке расположения приложения. При повторном старте приложения, открывается папка, в которой были при последнем выходе.
![screenshot of sample](https://i.ibb.co/mCdDS6s/crhby.png) 
---

###### Пример работы программы [Gif Images](https://i-download.imgflip.com/6cgfsm.gif)
